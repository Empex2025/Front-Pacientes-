      ...
      <ScrollView style={healthStyles.scrollContainer}>
        ...
        <View style={healthStyles.navigationButtons}>
          ...
          >
            <View style={healthStyles.navButtonContent}>
              ...
              <View style={[healthStyles.indicator, healthStyles.greenIndicator]} />
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={healthStyles.navButtonContent}>
              ...
              <View style={[healthStyles.indicator, healthStyles.purpleIndicator]} />
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={healthStyles.navButtonContent}>
              ...
              <View style={[healthStyles.indicator, healthStyles.orangeIndicator]} />
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={healthStyles.searchSection}>
          ...
          <View style={healthStyles.searchContainer}>
            ...
            <View style={healthStyles.searchInputContainer}>
              <SearchIcon />
              <TextInput
        ...
        <View style={healthStyles.professionalsSection}>
          <Text style={healthStyles.sectionTitle}>Profissional em Destaque</Text>
          <FlatList
            data={professionals}
